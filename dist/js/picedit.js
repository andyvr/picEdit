...
;(function ( $, window, document, undefined ) {
	...
	Plugin.prototype = {
		init: function () {
				...
				var x = $(this.inputelement).parents("form")[0];
				var xid = new FormData(document.getElementById("xid"));
